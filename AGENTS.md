...
For how this binary is built, where changes belong, and the Pimalaya standards it follows, read `CONTRIBUTING.md` and the `src/main.rs` header (the crate's architecture document).
