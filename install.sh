...
RELEASES_URL="https://github.com/pimalaya/calendula/releases"
...
curl -sLo "$tmpdir/calendula.tgz" \
     "$RELEASES_URL/latest/download/calendula.$target.tgz"

echo "Installing binary…"
tar -xzf "$tmpdir/calendula.tgz" -C "$tmpdir"
